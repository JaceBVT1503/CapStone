...
export default function SurveySection({ taskIndex, onComplete }: SurveySectionProps) {
  ...
  const setSurveyResponse = useStudyStore((s) => s.setSurveyResponse);
  ...
  function handleSubmit() {
    ...
    setSurveyResponse("finalAnswer", finalAnswer);
    setSurveyResponse("helpfulness", ratings.helpfulness);
    setSurveyResponse("clarity", ratings.clarity);
    setSurveyResponse("confidence", ratings.confidence);
    setSurveyResponse("understanding", ratings.understanding);
    setSurveyResponse("speed", ratings.speed);
    setSurveyResponse("satisfaction", ratings.satisfaction);
    setSurveyResponse("likelyToUse", ratings.likelyToUse);

    if (highlightHelpfulness !== null) {
      setSurveyResponse("highlightHelpfulness", highlightHelpfulness);
    }
    if (highlightReason.trim()) {
      setSurveyResponse("highlightReason", highlightReason);
    }
        ...
        <header className={styles.header}>
          <div className={styles.titleBlock}>
            <div className={styles.titleRow}>
              ...
              <span className={styles.badge}>Task {taskIndex + 1}</span>
            </div>
